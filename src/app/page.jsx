...
export default function Page() {
  return (
    <main className="flex min-h-screen flex-col p-6">
      <div className="flex flex-col md:flex-row items-center justify-between rounded-lg bg-blue-500 p-4 md:h-32">
        { <AcmeLogo className="mb-4 md:mb-0"/> }
        <nav className="flex flex-wrap justify-center md:justify-end gap-2 md:gap-8 w-full md:w-auto text-white text-lg">
